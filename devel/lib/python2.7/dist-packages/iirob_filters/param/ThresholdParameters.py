...
param_description = [{'constant': False, 'description': 'linear threshold', 'pytype': 'double', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'linear_threshold', 'min': None, 'default': 0, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'angular threshold', 'pytype': 'double', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'angular_threshold', 'min': None, 'default': 0, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'threshold for double', 'pytype': 'double', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'threshold', 'min': None, 'default': 0, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'linear threshold', 'pytype': 'double', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'linear_threshold', 'min': None, 'default': 0, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'angular threshold', 'pytype': 'double', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'angular_threshold', 'min': None, 'default': 0, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'threshold for double', 'pytype': 'double', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'threshold', 'min': None, 'default': 0, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}]
...
class ThresholdParameters(dict):
    def __init__(self):
