...
param_description = [{'constant': False, 'description': 'mean divider', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'divider', 'min': None, 'default': 4, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}]
...
class MovingMeanParameters(dict):
    def __init__(self):
